...
<body class="bg-white">
    ...
    <div class="flex justify-center">
        <button type="button" onclick="window.location.href='payment.php'" class="text-white bg-red-700 hover:bg-red-500 focus:outline-none focus:ring-4 focus:ring-red-900 font-medium rounded-full text-sm px-5 py-2.5 text-center">
            ต้องการชำระเงิน
        </button>
    </div>
