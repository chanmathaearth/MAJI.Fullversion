...
<body class="bg-white" style="
        ...
        <nav id="1">
            <div class="flex justify-between h-[6rem] px-10 shadow items-center smooth">
                ...
                <div class="flex space-x-4 items-center hidden sm:flex text-nowrap">
                    ...
                    <a href="../login/login.html"
                        class="text-red-700 text-sm transform hover:scale-[120%] hover:text-red-500 transition-transform duration-100">เข้าสู่ระบบ</a>
                    <a href="../signup/signup.html"
                        class="px-4 py-2 rounded text-red-700 transform hover:scale-[120%] hover:text-red-500 transition-transform duration-100 text-sm">สมัครสมาชิก</a>
                    <div
            ...
            <div class="hidden w-full" id="navbar-hamburger">
                <ul class="flex flex-col font-medium rounded-lg justify-center items-center bg-gray-50">
                    ...
                    <li>
                        <a href="../login/login.html"
                            class="block ml-2 py-2 px-3 text-red-700 hover:text-red-950">เข้าสู่ระบบ</a>
                    </li>
                    <li>
                        <a href="../signup/signup.html"
                            class="block ml-2 py-2 px-3 text-red-700 hover:text-red-950">สมัครสมาชิก</a>
                    </li>
                    <li>
    ...
    <div id="default-carousel" class="w-[100vw] h-[100vh] fixed mt-0 rounded-3xl" data-carousel="slide" style="background-size: cover;">
        <div class="relative h-screen object-cover overflow-hidden">
            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="poster3.png" class="absolute block w-full"
                    style="width: 100vw; height: 89vh; object-fit: cover;">
            </div>
        </div>
