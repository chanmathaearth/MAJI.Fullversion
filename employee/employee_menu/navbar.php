    ...
    <div class="overflow w-full md:block md:w-auto" id="navbar-default">
      <ul
        ...
        <li class="flex justify-items-center">
          <a href="#" class="block py-2 px-3 text-black bg-red-200 rounded md:bg-transparent md:text-red-500 md:p-0 "
            aria-current="page">
            <span class="flex"><svg class="w-6 h-6 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
