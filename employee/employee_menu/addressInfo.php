        ...
        <div class="flex justify-center">
            <div>
                <section class="w-full mb-[2%] ml-[2%] bg-white rounded-md mr-2 sm:py-8 lg:py-8">
                    <div class="w-full flex flex-wrap justify-center mb-2 p-5 bg-gray-100 ">
                        <div>
                    ...
                    <div class="grid grid-cols-1 text-gray-900 divide-y divide-gray-900 w-auto mx-auto px-4 sm:px-6 lg:px-8 mt-10">
                        ...
                        <div class="grid-cols-1 items-center ">
                            <button type="button" onclick="orderConfirm()" class="mt-2 mb-[2%] text-white bg-red-700 hover:bg-red-500 focus:outline-none focus:ring-4 focus:ring-red-900 font-medium rounded-full text-sm px-5 py-2.5 text-center">
                                ยืนยันการสั่งซื้อ
                            </button>
