...
$sqlfor90days = "SELECT SUM(amountMoney) AS totalAmount FROM `payment` WHERE DATE(paymentDateTime) >= DATE_SUB(CURDATE(), INTERVAL 90 DAY) AND DATE(paymentDateTime) <= CURDATE()";
